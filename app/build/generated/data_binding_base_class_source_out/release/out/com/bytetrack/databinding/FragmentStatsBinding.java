...
public final class FragmentStatsBinding implements ViewBinding {
  ...
  private FragmentStatsBinding(@NonNull LinearLayout rootView, @NonNull TabLayout tabLayout,
  ...
  public static FragmentStatsBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new FragmentStatsBinding((LinearLayout) rootView, tabLayout, viewPager);
    }
